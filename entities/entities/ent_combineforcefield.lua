...
hook.Add("ShouldCollide", "forcefield.ShouldCollide.Long", function(a, b)
	local field
	local ent

	if IsValid(a) and a:GetClass() == "ent_combineforcefield" then
		field = a
		ent = b
	elseif IsValid(b) and b:GetClass() == "ent_combineforcefield" then
		field = b
		ent = a
	end
