...
log.Default("[mounting] Registering base gamemode")
...
log.Default("[mounting] Registering module gamemode")

includes.Folder("custom") -- custom setting content
