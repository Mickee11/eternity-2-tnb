...
ITEM.Name 				= "BIO Faceplate"
ITEM.Description 		= "A specially designed metallic facemask, vocoder included, issued to members of the Intelligence Service."
...
if SERVER then
	function ITEM:GetModelData(ply)
		local model = string.format("models/tnb/halflife/%s_head_metrocop_elite.mdl", GAMEMODE:GetGenderString(ply:CharModel()))
