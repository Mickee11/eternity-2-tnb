...
ITEM.Name 				= "Stripped Rural Protection Uniform"
ITEM.Description 		= "A repurposed uniform once worn by a unit of the Rural Protection."

ITEM.Model 				= Model("models/tnb/halflife2/world_torso_metropolice.mdl")
ITEM.Material           = "models/tnb/cca/metropolice_body_rupol"
